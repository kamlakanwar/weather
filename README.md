...
You can view the live version of weather forcasting website at: <a href = https://kamlakanwar.github.io/weather/>Visit website ↗ </a>
...
1. **Clone the repository:**
    ```bash
    git clone https://github.com/kamlakanwar/weather
    ```
